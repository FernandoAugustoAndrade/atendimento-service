...
public class MedicacaoClient {
    ...
    public MedicacaoClient(RestClient.Builder restClientBuilder,
        ...
        try {
            restClient.patch()
                    ...
                    .onStatus(HttpStatusCode::is4xxClientError, (request, response) -> {
                        throw new ItemNaoEncontradoException("Medicacao nao encontrada ou estoque insuficiente");
                    })
                    .toBodilessEntity();
        } catch (ItemNaoEncontradoException exception) {
            throw exception;
        } catch (RestClientException exception) {
            throw new IntegracaoException("Nao foi possivel atualizar o estoque no medicacao-service");
        }
    }
}
